...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = function () {
	    ...
	    _createClass(View, [{
	        ...
	        value: function showBirthday() {
	            ...
	            var userData = this.user.friendList;
	
	            for (var i = 0; i < userData.length; i++) {
	
	                var email = userData[i];
	
	                var birthdayProfile = '<li><div class="birthday-person">' + '<img src=' + data.users[email].pictureUrl + '>' + '<h2>' + data.users[email].name + '</h2>' + '</div></li>';
	...
	var User = function User(name, email, pictureUrl, friendList) {
...
/***/ function(module, exports) {
	...
	var users = {
	  ...
	  "yosukeonrails@gmail.com": {
	    ...
	    password: '12345',
	    friendList: ["jonedc@gmail.com", "benrogojan@gmail.com", "kellykstong@gmail.com"],
...
/***/ }
/******/ ]);
//# sourceMappingURL=giftin.1.0.0.js.map